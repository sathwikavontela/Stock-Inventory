...
const AuthorityDeptReports = () => {
  ...
  const generatePDF = () => {
    const doc = new jsPDF();
    doc.text(`Reports for Department ID: ${departmentId}`, 14, 10);
    doc.autoTable({
    ...
    doc.save(`department-report-${departmentId}.pdf`);
  };
  ...
  return (
    <div className="container mx-auto p-6">
      <h2 className="text-xl font-bold mb-4">
        Reports for Department: {departmentId}
      </h2>
      <div className="mb-4">
        <input
          type="date"
...
export default AuthorityDeptReports;
